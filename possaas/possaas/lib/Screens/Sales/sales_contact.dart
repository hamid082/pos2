                        ...
                        children: [
                          ...
                          ListView.builder(
                              ...
                              itemBuilder: (_, index) {
                                ...
                                return (customer[index].phoneNumber.toLowerCase().contains(searchCustomer.toLowerCase()) ||
                                            customer[index].customerName.toLowerCase().contains(searchCustomer.toLowerCase())) &&
