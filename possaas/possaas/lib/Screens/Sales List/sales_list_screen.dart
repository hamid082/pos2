                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child: const Text('Yes, Delete Forever').onTap(() async {
                                                                            ...
                                                                            await delete.deleteDailyTransaction(
                                                                                invoice: reTransaction[index].invoiceNumber, status: 'Sale', field: "saleTransactionModel");
                                                                            DatabaseReference ref =
                                                                                FirebaseDatabase.instance.ref("${await getUserID()}/Sales Transition/${reTransaction[index].key}");
