...
class _SalesReturnState extends State<SalesReturn> {
  ...
  Future<void> saleReturn({required SalesTransitionModel salesModel, required SalesTransitionModel orginal, required WidgetRef consumerRef, required BuildContext context}) async {
    try {
              ...
              Expanded(
                child: GestureDetector(
                  onTap: () async {
                    ...
                    await saleReturn(salesModel: invoice, orginal: widget.saleTransactionModel, consumerRef: consumerRef, context: context);
                  },
                  child: Container(
                    height: 60,
                    decoration: const BoxDecoration(
