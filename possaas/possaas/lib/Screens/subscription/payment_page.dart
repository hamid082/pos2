                ...
                children: [
                  Material(
                    ...
                    shape: RoundedRectangleBorder(
                        ...
                        side: BorderSide(color: whichPaymentIsChecked == 'Bank Transfer' ? primaryColor : kGreyTextColor.withOpacity(0.2))),
                    color: Colors.white,
                  ...
                  Material(
                    elevation: 0.0,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Kkipay' ? primaryColor : kGreyTextColor.withOpacity(0.2))),
                    color: Colors.white,
                    child: CheckboxListTile(
                  ...
                  Material(
                    elevation: 0.0,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Paystack' ? primaryColor : kGreyTextColor.withOpacity(0.2))),
                    color: Colors.white,
                    child: CheckboxListTile(
                  ...
                  Material(
                    elevation: 0.0,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'BillPlz' ? primaryColor : kGreyTextColor.withOpacity(0.2))),
                    color: Colors.white,
                    child: CheckboxListTile(
                  ...
                  Material(
                    elevation: 0.0,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'CashFree' ? primaryColor : kGreyTextColor.withOpacity(0.2))),
                    color: Colors.white,
                    child: CheckboxListTile(
                  ...
                  Material(
                    elevation: 0.0,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: whichPaymentIsChecked == 'Iyzico' ? primaryColor : kGreyTextColor.withOpacity(0.2))),
                    color: Colors.white,
                    child: CheckboxListTile(
