            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  Text('About us',style: kTextStyle.copyWith(fontWeight: FontWeight.bold,color: kTitleColor,fontSize: 18),),
                   Text(widget.customerModel.note,style: kTextStyle.copyWith(color: kGreyTextColor),),
                   const SizedBox(height: 20,),
                   Text(
